...
try:
    ...
    print("ERROR: missing packages, see exception for details")
    print("💡 Run with nix-shell:")
    print("   nix-shell -p 'python3.withPackages (ps: with ps; [ requests click click-log packaging ])' --run 'python3 update_discourse_hub.py'")
    raise
